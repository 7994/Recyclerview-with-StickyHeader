...
//        findViewById(R.id.visibility_button).setOnClickListener(v -> recyclerView.setVisibility(recyclerView.getVisibility() == View.VISIBLE ? View.GONE : View.VISIBLE));
        findViewById(R.id.visibility_button).setOnClickListener(new View.OnClickListener() {
            @Override
